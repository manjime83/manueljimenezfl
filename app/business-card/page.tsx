...
const whatsappUrl = "https://wa.me/14076309767";
const qrUrl = "https://www.manueljimenezfl.com";
const qrDisplay = "manueljimenezfl.com";
const websiteUrl = "https://manueljimenezfl.com";
const phoneHref = "tel:+14076309767";
const phoneDisplay = "+1 407-630-9767";
...
function QrCode() {
  return (
    ...
    >
      <Image
        src="/qr-manueljimenezfl.svg"
        alt={`Código QR para ${qrDisplay}`}
        width={512}
        height={512}
        className="size-full"
      />
        ...
        <div className="grid w-full items-center justify-center gap-8 lg:grid-cols-[430px_430px]">
          ...
          <article className="relative flex aspect-[0.586/1] min-h-[734px] w-full max-w-[430px] flex-col overflow-hidden rounded-[22px] border border-[#d9d9dd] bg-white p-8">
            ...
            <div className="border-t border-[#d9d9dd] pt-6">
              <p className="font-mono text-xs tracking-normal text-[#75758a] uppercase">Escríbeme por WhatsApp</p>
              <a
                href={whatsappUrl}
                className="mt-4 flex items-center gap-4 rounded-[14px] bg-[#f7f6f2] px-4 py-4 text-[#212121] transition-colors hover:bg-[#f1f0eb] focus:ring-2 focus:ring-[#4c6ee6] focus:outline-none"
              >
            ...
            <div className="mt-6 border-t border-[#d9d9dd] pt-6">
              <p className="font-mono text-xs tracking-normal text-[#75758a] uppercase">Sígueme en redes sociales</p>
